...
var Matrix4 = function() {
    ...
    this.setRotationX = function(degrees) {
		...
		this.elements[5] = Math.cos(radians);
		this.elements[6] = -Math.sin(radians);
		this.elements[9] = Math.sin(radians);
		this.elements[10] = Math.cos(radians);
        return this;
    };
    ...
    this.setRotationY = function(degrees) {
		...
		var radians = (degrees/180) * Math.PI;
		this.elements[0] = Math.cos(radians);
		this.elements[2] = Math.sin(radians);
		this.elements[8] = -Math.sin(radians);
		this.elements[10] = Math.cos(radians);
        return this;
    };
    ...
    this.setRotationZ = function(degrees) {
		...
		var radians = (degrees/180) * Math.PI;
		this.elements[0] = Math.cos(radians);
		this.elements[1] = -Math.sin(radians);
		this.elements[4] = Math.sin(radians);
		this.elements[5] = Math.cos(radians);
        return this;
    };
    ...
    this.setPerspective = function(fovy, aspect, near, far) {
		...
		var fovRads = (fovy/180) * Math.PI;
		var t = Math.tan(fovRads/2);
		var r = t * aspect;
		
		this.elements[0] = near/r;
		this.elements[5] = near/t;
		this.elements[10] = -((far+near)/(far-near));
		this.elements[11] = -(2*near*far/(far-near));
		this.elements[14] = -1;
		this.elements[15] = 0;
        return this;
    };
